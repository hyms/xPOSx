...
public class SmsSettingsController : ControllerBase
{
    ...
    public SmsSettingsController(ISmsSettingsService settingsService)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> Create(SmsSettings settings)
    {
    ...
    [Authorize(Policy = "settings_edit")]
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(long id, SmsSettings settings)
    {
