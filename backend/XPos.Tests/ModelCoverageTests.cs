...
public class ModelCoverageTests
{
    ...
    public void TouchAllModelsAndDtos()
    {
        ...
        var product = new Product { Id = 1, Name = "P", Code = "C", CategoryId = 1, UnitId = 1, UnitPurchaseId = 1, UnitSaleId = 1, Cost = 10, Price = 20, Stock = 100, StockAlert = 10, Image = "img", TaxNet = 0, TaxMethod = "1", Note = "N", IsVariant = false, NotSelling = false, IsActive = true, Category = new Category(), Unit = new Unit() };
        _ = product.Id; _ = product.Name; _ = product.Code; _ = product.CategoryId; _ = product.UnitId; _ = product.UnitPurchaseId; _ = product.UnitSaleId; _ = product.Cost; _ = product.Price; _ = product.Stock; _ = product.StockAlert; _ = product.Image; _ = product.TaxNet; _ = product.TaxMethod; _ = product.Note; _ = product.IsVariant; _ = product.NotSelling; _ = product.IsActive; _ = product.Category; _ = product.Unit;
