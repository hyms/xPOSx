            ...
            <div class="content">
                <div v-if="purchase.voucher" class="voucher-info q-mb-md">
                    <div :style="{ fontFamily: 'var(--font-family-body)' }">
                        <strong>Tipo:</strong>
                        {{ purchase.voucher.voucherType }}
                    </div>
                    <div :style="{ fontFamily: 'var(--font-family-body)' }">
                        <strong>Número:</strong>
                        {{ purchase.voucher.voucherNumber }}
                    </div>
                    <div :style="{ fontFamily: 'var(--font-family-body)' }">
                        <strong>CAE:</strong> {{ purchase.voucher.cae }}
                    </div>
                    <div
                        v-if="purchase.voucher.caeExpiration"
                        :style="{ fontFamily: 'var(--font-family-body)' }"
                    >
                        <strong>Vencimiento CAE:</strong>
                        {{
                            new Date(
                                purchase.voucher.caeExpiration,
                            ).toLocaleDateString()
                        }}
                    </div>
                </div>
                ...
                <table class="items-table">
                    ...
                    <tbody>
                        <tr
                            v-for="item in purchase.details"
                            :key="item.productId"
                        >
                            <td
                                :style="{
                ...
                <div class="totals text-right">
                    <div
                        ...
                        :style="{ fontFamily: 'var(--font-family-display)' }"
                    >
                        Total: {{ formatCurrency(purchase.grandTotal) }}
                    </div>
                </div>
            </div>
