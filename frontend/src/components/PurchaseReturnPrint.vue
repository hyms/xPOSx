        ...
        <div class="print-container" v-if="returnDoc">
            <div class="header text-center">
                ...
                >
                    ...
                    {{
                        returnDoc.date
                            ? new Date(returnDoc.date).toLocaleString()
                            : ""
                    }}
                </div>
            </div>
            ...
            <div class="content">
                <div v-if="returnDoc.voucher" class="voucher-info q-mb-md">
                    <div :style="{ fontFamily: 'var(--font-family-body)' }">
                        <strong>Tipo:</strong>
                        {{ returnDoc.voucher.voucherType }}
                    </div>
                    <div :style="{ fontFamily: 'var(--font-family-body)' }">
                        <strong>Número:</strong>
                        {{ returnDoc.voucher.voucherNumber }}
                    </div>
                    <div :style="{ fontFamily: 'var(--font-family-body)' }">
                        <strong>CAE:</strong> {{ returnDoc.voucher.cae }}
                    </div>
                    <div
                        v-if="returnDoc.voucher.caeExpiration"
                        :style="{ fontFamily: 'var(--font-family-body)' }"
                    >
                        <strong>Vencimiento CAE:</strong>
                        {{
                            new Date(
                                returnDoc.voucher.caeExpiration,
                            ).toLocaleDateString()
                        }}
                    </div>
                </div>
                ...
                <table class="items-table">
                    ...
                    <tbody>
                        <tr
                            v-for="item in returnDoc.details"
                            :key="item.productId"
                        >
                            <td
                                :style="{
                ...
                <div class="totals text-right">
                    ...
                    >
                        Total a Devolver:
                        {{ formatCurrency(returnDoc.grandTotal) }}
                    </div>
                </div>
            </div>
