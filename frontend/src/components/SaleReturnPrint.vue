    ...
    <div class="print-page">
        <div class="print-container" v-if="saleReturn">
            <div class="header text-center">
                ...
                >
                    Comprobante Devolución de Venta
                </div>
                <div
                ...
                <div
                    ...
                    :style="{ fontFamily: 'var(--font-family-body)' }"
                >
                    Fecha: {{ new Date(saleReturn.date).toLocaleString() }}
                </div>
            </div>
            ...
            <div class="content">
                <div v-if="saleReturn.voucher" class="voucher-info q-mb-md">
                    <div :style="{ fontFamily: 'var(--font-family-body)' }">
                        <strong>Tipo:</strong>
                        {{ saleReturn.voucher.voucherType }}
                    </div>
                    <div :style="{ fontFamily: 'var(--font-family-body)' }">
                        <strong>Número:</strong>
                        {{ saleReturn.voucher.voucherNumber }}
                    </div>
                    <div :style="{ fontFamily: 'var(--font-family-body)' }">
                        <strong>CAE:</strong> {{ saleReturn.voucher.cae }}
                    </div>
                    <div
                        v-if="saleReturn.voucher.caeExpiration"
                        :style="{ fontFamily: 'var(--font-family-body)' }"
                    >
                        <strong>Vencimiento CAE:</strong>
                        {{
                            new Date(
                                saleReturn.voucher.caeExpiration,
                            ).toLocaleDateString()
                        }}
                    </div>
                </div>
                ...
                <table class="items-table">
                    ...
                    <tbody>
                        <tr
                            v-for="item in saleReturn.details"
                            :key="item.productId"
                        >
                            <td
                                :style="{
                ...
                <div class="totals text-right">
                    ...
                    >
                        Total a Devolver:
                        {{ formatCurrency(saleReturn.grandTotal) }}
                    </div>
                </div>
            </div>

            <div
                class="footer text-center q-mt-lg"
                :style="{ fontFamily: 'var(--font-family-body)' }"
            >
...
.print-page {
    ...
    background-color: var(
        --color-background-elevated-light
    ); /* Light background for print preview */
