                ...
                <q-form @submit="onSubmit" class="q-gutter-md">
                    ...
                    <div class="row justify-end q-gutter-sm q-mt-md">
                        ...
                        <q-btn
                            ...
                            type="submit"
                            :loading="saving"
                            :disable="formData.details.length === 0 || isEdit"
                        />
                    </div>
                </q-form>
            </q-card-section>
    ...
    try {
        ...
        if (adjustmentId) {
            ...
            try {
                ...
                $q.notify({
                    color: "negative",
                    message: "Error al cargar el ajuste para visualización",
                });
...
const addProduct = (product: Product) => {
    ...
    const existing = formData.details.find(
        (d: AdjustmentDetail) => d.productId === product.id,
    );
    if (existing) {
        existing.quantity++;
    } else {
...
const onSubmit = async () => {
    ...
    try {
        ...
        $q.notify({
            color: "positive",
            message: "Ajuste de inventario guardado con éxito",
        });
        router.push("/adjustments");
    } catch (error) {
