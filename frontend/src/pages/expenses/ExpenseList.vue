    ...
    <q-card>
      ...
      <q-tab-panels v-model="tab" animated>
        ...
        <q-tab-panel name="expenses">
          ...
          >
            <template v-slot:top-right>
              <q-btn color="primary" label="Nuevo Gasto" icon="add" @click="openExpenseDialog()" />
            </template>
            ...
            <template v-slot:body-cell-actions="props">
              <q-td :props="props">
                <q-btn flat round color="primary" icon="edit" @click="openExpenseDialog(props.row)" />
                <q-btn flat round color="negative" icon="delete" @click="confirmDeleteExpense(props.row)" />
              </q-td>
            </template>
          </q-table>
        </q-tab-panel>
        ...
        <q-tab-panel name="categories">
          ...
          >
            <template v-slot:top-right>
              <q-btn color="primary" label="Nueva Categoría" icon="add" @click="openCategoryDialog()" />
            </template>

            <template v-slot:body-cell-actions="props">
              <q-td :props="props">
                <q-btn flat round color="primary" icon="edit" @click="openCategoryDialog(props.row)" />
                <q-btn flat round color="negative" icon="delete" @click="confirmDeleteCategory(props.row)" />
              </q-td>
            </template>
          </q-table>
        </q-tab-panel>
...
const expenseColumns = [
  ...
  { name: 'categoryName', label: 'Categoría', field: 'categoryName', sortable: true, align: 'left' as const },
  { name: 'warehouseName', label: 'Almacén', field: 'warehouseName', sortable: true, align: 'left' as const },
  { name: 'amount', label: 'Monto', field: 'amount', sortable: true, align: 'right' as const },
...
const fetchCategories = async () => {
  ...
  try {
    ...
    categoryOptions.value = response.data.map(c => ({ label: c.name, value: c.id }))
  } catch (error) {
...
const fetchWarehouses = async () => {
  try {
    ...
    warehouseOptions.value = response.data.map(w => ({ label: w.name, value: w.id }))
  } catch (error) {
...
const openCategoryDialog = (category?: ExpenseCategory) => {
  if (category) {
    ...
    Object.assign(categoryForm, { id: undefined, name: '', description: '' })
  }
