    ...
    >
                            ...
                            >
                                ...
                                >
                                    <div
                                        ...
                                        :style="{
                                            backgroundColor:
                                                'rgba(var(--color-background-dark-rgb), 0.6)',
        ...
        <div class="lt-md column full-height">
                ...
                <div class="row q-col-gutter-sm">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <div
                                    class="absolute-bottom text-caption text-center q-pa-xs"
                                >
                                    {{ formatCurrency(product.price) }}
                                </div>
                            </q-img>
            ...
            <q-page-sticky position="bottom-right" :offset="[18, 18]">
                ...
                >
                    <q-badge color="negative" floating v-if="cart.length > 0">{{
                        cart.length
                    }}</q-badge>
                </q-btn>
            </q-page-sticky>
            ...
            >
                <q-card class="column no-wrap" style="height: 80vh">
                    ...
                    <q-card-section class="col scroll q-pt-md">
                        <!-- Reuse Cart List Logic here or extract to component -->
                        <div
                            v-if="cart.length === 0"
            ...
            <q-card style="width: 500px">
                ...
                <q-card-section class="q-pa-lg">
                    ...
                    <div class="row q-col-gutter-sm">
                        ...
                        <div
                            class="col-12 flex q-gutter-sm justify-center q-mb-md"
                        >
                            <q-btn
...
const handleBarcodeScan = () => {
    ...
    if (exactMatch) {
        ...
        $q.notify({
            color: "warning",
            message: "Producto no encontrado por código",
            timeout: 1000,
        });
    }
};
