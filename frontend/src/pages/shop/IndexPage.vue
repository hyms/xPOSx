<template>
  <q-page class="q-pb-xl" :class="$q.dark.isActive ? 'bg-dark' : 'bg-grey-1'">
    
    <!-- Hero / Promotional Carousel -->
    <div class="hero-banner relative-position overflow-hidden">
      ...
      >
        <q-carousel-slide :name="1" class="column no-wrap flex-center text-white q-px-lg">
          ...
          <h2 class="text-h2 text-weight-bolder text-center leading-tight q-my-none">
            Preventas Exclusivas QR
          </h2>
          <p class="text-h5 text-center q-mt-md q-mx-auto max-width-md opacity-90">
          ...
          <q-btn 
            ...
            size="lg" 
            no-caps 
            class="q-mt-xl shadow-glow text-weight-bold touch-btn-48" 
          />
        </q-carousel-slide>
    ...
    <div class="container q-mx-auto q-px-md max-width-lg q-mt-xl">
      ...
      <div class="text-center q-mb-xl">
        ...
        <div class="row q-col-gutter-md justify-center q-mt-md">
          <div 
            ...
            :key="cat.id" 
            class="col-6 col-sm-4 col-md-2 cursor-pointer"
      ...
      <div class="q-mb-xl">
        ...
        <!-- Empty State -->
        <div v-else-if="products.length === 0" class="text-center q-py-xl glass-card">
